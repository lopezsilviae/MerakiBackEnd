...
DROP TABLE IF EXISTS `tipomateriales`;
...
CREATE TABLE `tipomateriales` (
  ...
  UNIQUE KEY `idtipoMaterial_UNIQUE` (`idtipoMaterial`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='los materiales q se trabajan';
...
LOCK TABLES `tipomateriales` WRITE;
/*!40000 ALTER TABLE `tipomateriales` DISABLE KEYS */;
/*!40000 ALTER TABLE `tipomateriales` ENABLE KEYS */;
UNLOCK TABLES;
