...
CREATE TABLE `consultas` (
  ...
  `contesto` bit(1) DEFAULT b'0',
  `quienRespondio` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`idconsulta`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='registra las consultas para contestar';
